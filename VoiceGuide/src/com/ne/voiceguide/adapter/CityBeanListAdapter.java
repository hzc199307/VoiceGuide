package com.ne.voiceguide.adapter;
...
public class CityBeanListAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int id = mContext.getResources().getIdentifier("city_"+myCityBean.getCityPinyin() ,"drawable",APP.packageName);
		holder.helloImage.setImageResource(id);
		Log.v(TAG, "getView id :"+id);
		return convertView;
	}
